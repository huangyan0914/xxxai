<template>
  <div :val="value_">
    <div>
      <el-radio v-model="data.type" label="1" size="mini" border>每周</el-radio>
    </div>
    <div>
    ...
    <div>
      <el-radio v-model="data.type" label="7" size="mini" border
        >指定周</el-radio
      >
      <span style="margin-left: 10px; margin-right: 5px">本月第</span>
      <el-input-number
        @change="data.type = '7'"
        v-model="data.week.start"
        :min="1"
        :max="4"
        size="mini"
        style="width: 100px"
    ...
    <div>
      ...
      <el-checkbox-group v-model="data.appoint" style="line-height: 25px">
        <el-checkbox
          @change="data.type = '4'"
          v-for="num in 7"
          :key="num"
