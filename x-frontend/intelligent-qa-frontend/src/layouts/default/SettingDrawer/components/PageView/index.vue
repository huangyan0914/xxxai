<template>
  ...
  <n-space vertical size="large">
    ...
    <setting-menu label="导航栏">
      <n-switch
        :value="theme.header.navbar.visible"
        @update:value="theme.setHeaderNavbarVisible"
      />
    </setting-menu>
    <setting-menu label="导航栏图标">
      <n-switch
        :value="theme.header.navbar.showIcon"
        @update:value="theme.setHeaderNavbarIconVisible"
      />
    </setting-menu>
